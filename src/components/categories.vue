<template>
    <div>
        <!-- 面包屑 -->
        <my-bread _2title="商品管理" _3title="商品分类"></my-bread>
        <!-- 输入框 -->
        <el-row>
            <el-col :span="12">
                <el-button type="success" plain @click.native="addFormVisible = true">添加分类</el-button>
            </el-col>
        </el-row>
        <!-- 表格 -->
        <el-table :data="categoryList" style="width: 100%" border>
            ...
            <el-table-column label="分类名称" width="300" prop="email"></el-table-column>
            <el-table-column label="级别" width="120" prop="mobile"></el-table-column>
            <el-table-column label="是否有效" width="120" prop="mobile"></el-table-column>
